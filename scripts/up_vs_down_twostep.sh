#!/usr/bin/env sh
#SBATCH --job-name=up_vs_down_twostep
#SBATCH --mail-type=END
#SBATCH --mail-user=b.kopperud@lmu.de
#SBATCH --mem-per-cpu=4GB
#SBATCH --output=logs/up_vs_down_twostep.log
#SBATCH --error=logs/up_vs_down_twostep.err
...
julia --threads ${SLURM_CPUS_PER_TASK} scripts/up_vs_down_inference_twostep.jl > logs/up_vs_down_twostep.txt
